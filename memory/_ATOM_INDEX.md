...
| decisions | memory/decisions.md | 決策, 記憶系統, 原子記憶, guardian, hooks, MCP, 架構細節, vector service, context budget |
...
| toolchain | memory/toolchain.md | 工具鏈, 環境設定, MCPControl, MCP新增, npm全域, 螢幕截圖, Excel MCP, LanceDB, MSYS2, cp950, PowerShell截圖, 向量服務 |
